...
<cfinvoke method="getReceptionistData" component="../../../services/adminServices/adminQueries.cfc" returnvariable="doctorData">
...
<cfif structKeyExists(form, "update-btn")>
    ...
    <cfif mailExists EQ false>
        <cfset form.doctor_id = receptionistIdToUpdate/>

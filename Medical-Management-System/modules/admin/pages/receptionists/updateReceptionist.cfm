                    ...
                    <div class="d-flex gap-4">
                        <div class="form-check d-flex flex-column gap-2">
                            ...
                            <div>
                                ...
                                <input name="password" class="form-control" value=#receptionistData.password# type="text" id="password" required placeholder="Password *"/>
                        ...
                        <div class="form-check d-flex flex-column gap-2">
                            <div>
                                ...
                                <input name="email" class="form-control" value=#receptionistData.email# type="email" id="email" required placeholder="Email *"/>
...
<cfif structKeyExists(form, "update-btn")>
    ...
    <cfif receptionistData.email NEQ form.email>
